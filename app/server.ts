...
export async function identity(){const user=await currentUser();const role=user?.role;return {user,role,admin:role==='admin',staff:role==='staff',operator:role==='admin'||role==='staff',client:role==='client'}}
