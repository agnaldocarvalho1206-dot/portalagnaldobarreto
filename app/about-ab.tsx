...
<section className="ab-profile-band-v63" id="perfil"><div className="container ab-profile-v63">
  <div className="ab-profile-visual-v63"><div className="ab-profile-glow-v63" aria-hidden="true"/><img className="ab-profile-mark-v63" src="/monograma.png" alt="" aria-hidden="true" width="1254" height="1254" loading="lazy"/><NotebookPortrait className="ab-corporate-v63" src="/agnaldo.png" alt="Agnaldo Barreto sorrindo em sua mesa com notebook AB" width="1862" height="845" loading="lazy"/><div className="ab-profile-caption-v63"><span>AGNALDO BARRETO</span><small>WEB DESIGNER</small></div></div>
