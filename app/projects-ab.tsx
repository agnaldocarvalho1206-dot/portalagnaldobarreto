...
<section className="ab-projects-cta ab-projects-cta-v64"><div className="container ab-projects-cta-inner-v64"><div className="ab-projects-cta-image-v64"><img className="ab-cta-monogram-v64" src="/monograma.png" alt="" aria-hidden="true" width="1254" height="1254" loading="lazy"/><NotebookPortrait className="ab-cta-portrait-v64" src="/agnaldo.png" alt="Agnaldo Barreto sorrindo em sua mesa com notebook AB" width="1862" height="845" loading="lazy"/></div><div className="ab-projects-cta-copy-v64"><div className="eyebrow">SEU PROJETO PODE SER O PRÓXIMO</div><h2>Uma boa solução começa com <em>contexto e direção.</em></h2><p>Conte sua ideia, a necessidade e o momento do seu negócio. Vamos organizar prioridades antes de decidir a melhor solução.</p><a className="button" href="/contato">Iniciar uma conversa <ArrowRight size={18}/></a></div><ul className="ab-projects-benefits-v64">{[[MessagesSquare,'Atendimento próximo'],[Target,'Diagnóstico do cenário'],[FileCheck,'Escopo organizado'],[ShieldCheck,'Acompanhamento das etapas']].map(([Icon,label]:any)=><li key={label}><Icon size={20}/><span>{label}</span></li>)}</ul></div></section>
</main>}